...
//        DataTypes theType = Helpers::getTypeForKeyword(theToken);
...
//                                    theToken.data)) {
//         anOp.setAttribute(
//            theToken,aSchema.getIndex(),theAttr->getType());
//       }
...
//        Expression* theExpression = &theExpr;
//        std::unique_ptr<Expression> theExpressionUnique(theExpression);
//        aList.push_back(std::move(theExpressionUnique));
//        if(!tokenizer.skipIf(',')) {
//          break;
//        }
//      }
